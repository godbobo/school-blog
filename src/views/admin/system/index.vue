    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="用户列表" name="lst">
        ...
        <el-table ref="filterTable" :data="tableData" :stripe="true" style="width: 100%">
          ...
          <el-table-column prop="college" label="所属话题"/>
          <el-table-column :formatter="formatter" prop="role" label="作者"/>
          <el-table-column prop="tel" label="浏览量"/>
          <el-table-column prop="tel" label="更新时间"/>
